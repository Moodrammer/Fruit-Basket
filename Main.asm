...
TIME DW 200 ;GAME TIME 200 SECONDS
...
PUSH DI
    ...
    CMP CURR_MES_NUM,1
    JNE MESS_2
    PRINT_MESSAGE MES1, MES1_SIZE, 5, 23, 0FH
    JMP END_MESSAGE_PICK
    MESS_2:
    CMP CURR_MES_NUM,2
    JNE MESS_3
    PRINT_MESSAGE MES2, MES2_SIZE, 5, 23, 0FH
    JMP END_MESSAGE_PICK
    MESS_3:
    CMP CURR_MES_NUM,3
    JNE MESS_4
    PRINT_MESSAGE MES3, MES3_SIZE, 5, 23, 0FH
    JMP END_MESSAGE_PICK
    MESS_4:
    PRINT_MESSAGE MES4, MES4_SIZE, 5, 23, 0FH
    END_MESSAGE_PICK:
POP DI
POP SI    
RET
...
INTERFACE PROC
    ...
    ;PRESS ESC TO EXIT
    PRINT_MESSAGE ESC_MES, ESC_MES_SIZE, 12, 20, 02H
...
PUSH SI
    ...
    JG SKIP_RED_COLORING
        MOV MES_COLOR, 04H
    SKIP_RED_COLORING:
    PRINT_MESSAGE TIME_STRING,H2A_STRING_SIZE, 18, 1, MES_COLOR 
POP SI
POP AX    
RET 
PRINT_TIME ENDP
